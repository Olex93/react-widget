...
const initialState = {
  ...
  bodyFont: "{ 'fontFamily': 'Arial, Helvetica, sansSerif' }",
  titleFont: "{ 'fontFamily': 'typeFont, Arial, Helvetica, sansSerif, 'fontWeight': '700', 'fontSize': '30px' }",
  standFirstFont:"{ 'fontFamily': 'Arial, Helvetica, sansSerif' }",
